    ...
    <section class="bg-white">
        <div class="py-8 px-4 mx-auto max-w-2xl lg:py-16">
            ...
            <form action="{{ route('admin.add.supplier.post') }}" method="POST">
                ...
                <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                    <div class="sm:col-span-2">
                        ...
                        <input type="text" name="company_name" id="company_name"
                            ...
                            placeholder="Type company name" value="{{ old('company_name') }}">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="commercial_register" id="commercial_register"
                            ...
                            placeholder="e.g. 12345678" value="{{ old('commercial_register') }}">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="phone" id="phone"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:border-purple-500 block w-full p-2.5 border-2 border-solid"
                            placeholder="e.g. +97312345678" value="{{ old('phone') }}">
                    </div>
                ...
                <x-submit-button>Add Supplier</x-submit-button>
            </form>
        </div>
    </section>
@endsection
