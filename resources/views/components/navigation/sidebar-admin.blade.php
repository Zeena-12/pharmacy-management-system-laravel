        ...
        <ul class="space-y-2 font-medium">
            ...
            <li>
                <a href="{{route("admin.report")}}"
                    ...
                    <svg class="w-5 h-5 text-purple-500 transition duration-75 dark:text-purple-400 group-hover:text-purple-900 dark:group-hover:text-white"
            ...
            <li>
                <a href="{{route('admin.view.supplier')}}"
                    class="flex items-center p-2 text-purple-900 rounded-lg dark:text-white hover:bg-purple-100 dark:hover:bg-purple-700 group">
                    <svg class="flex-shrink-0 w-5 h-5 text-purple-500 transition duration-75 dark:text-purple-400 group-hover:text-purple-900 dark:group-hover:text-white"
                        aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 18">
                        <path
            ...
            <li>
                <a href="{{route('admin.view.stock_requests')}}"
                    ...
                    <span class="flex-1 ms-3 whitespace-nowrap">Stock Requests</span>
                </a>
            </li>
